...
const ModalStudentURL = React.memo(({ isOpenDialog, handleClose, refreshQR }) => {
  const { t } = useTranslation();
  const studentURL = useSelector((state) => state.monitoring.studentURL);
  const notify = () =>
                  ...
                  <div className="rounded-lg bg-white w-full">
                    ...
                    >
                      <input
                        ...
                        type="text"
                        readOnly
                        value={studentURL?.url}
                      />
                      <CopyToClipboard onCopy={copyUrl} text={studentURL?.url}>
                        <button
                    ...
                    <div className="px-5 py-0 text-center mb-2">
                      <div className="grid grid-cols-2 content-center">
                        ...
                        <div>
                          <a href={studentURL?.qrcode} download="qrcode.jpg">
                            <button
                            ...
                            >
                              <FontAwesomeIcon
                                ...
                                className="text-white mr-2"
                              ></FontAwesomeIcon>
                              {t("teacher.student_url.qr_download")}
                            </button>
                          </a>
                        </div>
                      </div>
...
export default ModalStudentURL;
